...
trn_ds = SSBMDataset(src_dir="./2020_12_04_falcon_v_fox_fd_2.0.1_csv/train", char_id=2, window_size=60, frame_delay=15, output_recent_actions=True, include_opp_input=False, device='cpu')
val_ds = SSBMDataset(src_dir="./2020_12_04_falcon_v_fox_fd_2.0.1_csv/eval", char_id=2, window_size=60, frame_delay=15, output_recent_actions=True, include_opp_input=False, device='cpu')
...
torch.save(model.state_dict(), "./weights/lstm_recent_action_no_opp_input_delay_15_2020_12_05.pth")

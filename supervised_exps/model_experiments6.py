...
trn_ds = SSBMDataset(src_dir="./dev_data_csv/train", char_id=2, opponent_id=1, window_size=60, frame_delay=15, output_recent_actions=True, device='cpu')
val_ds = SSBMDataset(src_dir="./dev_data_csv/valid", char_id=2, opponent_id=1, window_size=60, frame_delay=15, output_recent_actions=True, device='cpu')

...
trn_ds = SSBMDataset(src_dir="./dev_data_csv/train", char_id=2, opponent_id=1, window_size=120, device='cpu')
val_ds = SSBMDataset(src_dir="./dev_data_csv/valid", char_id=2, opponent_id=1, window_size=120, device='cpu')
...
for exp in experiments:
    model = SSBM_LSTM_Prob(
        ...
        out_hidden_sizes=out_hidden_sizes
    )

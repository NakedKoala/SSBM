...
# NOTE: use frame number as a feature
...
trn_dl = DataLoader(trn_ds, batch_size=512, shuffle=True, num_workers=0)
val_dl = DataLoader(val_ds, batch_size=512, shuffle=True, num_workers=0)
...
# NOTE: train with held-input-loss-factor
train_prob.train(model, trn_dl, val_dl, 6, 0, ActionHead.MAX, 2000, True, device, initial_lr=0.0005)

torch.save(model.state_dict(), "./weights/lstm_held_input_factor_0_no_opp_input_delay_15_big_batch_2020_12_09_falcon_v_falcon_fd.pth")

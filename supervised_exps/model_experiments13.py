...
train_prob.train(model, trn_dl, val_dl, 3, 0, ActionHead.MAX, 2000, True, device, initial_lr=0.001)

torch.save(model.state_dict(), "./weights/lstm_held_input_factor_0_no_opp_input_delay_15_2020_12_09_falcon_v_falcon_fd.pth")
